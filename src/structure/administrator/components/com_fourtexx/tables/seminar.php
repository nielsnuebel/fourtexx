...
/**
 * FourtexxTableSeminar table.
 *
 * @package   com_fourtexx
 * @since     1.0.0
 */
class FourtexxTableSeminar extends Table
{
	/**
	...
	{
		parent::__construct('#__fourtexx_seminars', 'id', $db);
	...
	protected function _getAssetName()
	{
		...
		return 'com_fourtexx.seminar.' . (int) $this->$k;
	}
	...
	public function store($updateNulls = false)
	{
		...
		$table = Table::getInstance('Seminar', 'FourtexxTable', array('dbo' => $this->getDbo()));
