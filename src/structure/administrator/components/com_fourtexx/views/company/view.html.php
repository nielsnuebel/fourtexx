 ...
 * @since    1.6
 */
class FourtexxViewCompany extends HtmlView
{
	/**
	 * The JForm object
	 *
	...
	private function toolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_FOURTEXX_MANAGER_COMPANY_NEW') :
			JText::_('COM_FOURTEXX_MANAGER_COMPANY_EDIT'), 'pencil-2');
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_fourtexx.company', $this->item->id);
			}
