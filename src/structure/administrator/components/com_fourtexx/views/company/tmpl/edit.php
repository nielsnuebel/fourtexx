...
<form action="<?php echo JRoute::_('index.php?option=com_fourtexx&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="company-form" enctype="multipart/form-data" class="form-validate">
