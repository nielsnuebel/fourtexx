 ...
 * @since    1.6
 */
class FourtexxViewRegistration extends HtmlView
{
	/**
	 * The JForm object
	 *
	...
	private function toolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_FOURTEXX_MANAGER_REGISTRATION_NEW') :
			JText::_('COM_FOURTEXX_MANAGER_REGISTRATION_EDIT'), 'pencil-2');
		...
		{
			JToolbarHelper::save2new('registration.save2new');
		}

		// If an existing item, can save to a copy.
		if (!$isNew && $canDo->get('core.create'))
		{
			JToolbarHelper::save2copy('registration.save2copy');
		}
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_fourtexx.registration', $this->item->id);
			}
