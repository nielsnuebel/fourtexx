 ...
 * @since    1.6
 */
class FourtexxViewDate extends HtmlView
{
	/**
	 * The JForm object
	 *
	...
	private function toolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_FOURTEXX_MANAGER_DATE_NEW') :
			JText::_('COM_FOURTEXX_MANAGER_DATE_EDIT'), 'pencil-2');
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_fourtexx.date', $this->item->id);
			}
